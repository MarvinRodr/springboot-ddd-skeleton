...
public class StringValueObject extends ValueObject<String> implements Serializable {
    ...
    public final Boolean isLengthBetweenInclusive(
            final int minValue,
            final int maxValue
    ) {
    ...
    public final Boolean isBetweenInclusive(
            final StringValueObject minValue,
            final StringValueObject maxValue
    ) {
        return isLengthBetweenInclusive(minValue.value(), maxValue.value());
    }

    public final Boolean isLengthBetweenExclusive(
            final int minValue,
            final int maxValue
    ) {
